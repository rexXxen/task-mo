        ...
        <div className="w-full">
          ...
          {isEditing ? (
            <form action={onSubmit} ref={formRef} className="space-y-2">
              <FormTextarea
                id="description"
                className="w-full mt-2 dark:bg-neutral-800 dark:text-neutral-200"
            ...
            <div
              ...
              role="button"
              className="min-h-[78px] bg-neutral-200 dark:bg-neutral-800 text-sm font-medium py-3 px-3.5 rounded-md dark:text-neutral-200"
            >
